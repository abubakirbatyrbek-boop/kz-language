...
function renderPlacement(){
  ...
  function renderChoice(){
    ...
    area.querySelector('#skipPlacement').onclick=()=>{
      ...
      const next=qs('next'); location.href=next||`path.html?lang=${lang}`;
    };
